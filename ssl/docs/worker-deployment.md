...
3. **Add AI Services**: เพิ่ม OpenAI/Claude/Ollama integration
...
### Ollama Integration
- รองรับ local AI models
- ตั้งค่าผ่าน OLLAMA_BASE_URL และ OLLAMA_MODEL
- ทางเลือกสำหรับ OpenAI และ Claude

### Rich Messages
- ข้อความแบบการ์ดสวยงาม
- แสดงผลการวิเคราะห์แบบโครงสร้าง
- ปุ่มโต้ตอบสำหรับการวิเคราะห์ใหม่

### Loading Animations
- แสดงสถานะกำลังประมวลผล
- ปรับปรุงประสบการณ์ผู้ใช้
- รองรับ LINE Loading Animation API

### Extended Quota
- เพิ่มจาก 4 เป็น 10 requests ต่อวัน
- การจัดการ quota แบบ user-based
- Reset อัตโนมัติทุกวัน

### Domain Support
- รองรับ hora.aq1.co domain
- การตั้งค่า custom domain ผ่าน Cloudflare
